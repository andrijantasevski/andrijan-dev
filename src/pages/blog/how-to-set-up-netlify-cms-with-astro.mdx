...
imageThumbnail: "/blog-thumbnails/astro-netlify-thumbnail.png"
...
If you want to follow this guide step-by-step, you can download my minimal starter Astro template from GitHub:

[_Minimal Astro Starter Template_](https://github.com/andrijantasevski/astro-minimal-starter)

Alternatively, you can check out the completed repository and start developing your project right away:
