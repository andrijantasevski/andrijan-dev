...
const Snippets: React.FC<Props> = ({ snippetsArr }) => {
  ...
  return (
    <section className="py-4 text-gray-900 dark:text-gray-50">
      <div className="mx-auto w-11/12 lg:w-7/12 2xl:w-5/12">
        <div className="mb-6">
          <h2 className="mb-3 text-2xl font-bold lg:text-3xl">Snippets</h2>
          <p>
            Useful snippets of code and boilerplate that help me be more
            productive when I am coding.
          </p>
        </div>
        ...
        <label className="mb-6 flex cursor-pointer items-center rounded-md border-2 border-gray-200 p-2 dark:border-gray-700">
          ...
          <input
            ...
            className="w-full border-0 bg-transparent text-gray-900 focus:border-0 focus:ring-0 dark:text-gray-50"
            type="search"
